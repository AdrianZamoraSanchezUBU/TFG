...
\noindent\includegraphics[width=\textwidth]{cabecera}\vspace{1cm}%
  ...
  {%
    \noindent\LARGE
    Presentado por \@author{Adrián Zamora Sánchez}\\ 
    en Universidad de Burgos --- \@date{}\\
    Tutor: \@tutor{César Ignacio García Osorio}\\
  }%
  \end{center}%
  \null
  \cleardoublepage
...
% Datos de portada
\title{Diseño e implementación de un lenguaje de programación y su compilador \\Documentación Técnica}
\author{}
\tutor{}
\date{\today}
