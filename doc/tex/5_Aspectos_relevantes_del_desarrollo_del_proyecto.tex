...
\begin{itemize}
    \item \textbf{Propagación y plegado de constantes (Constant propagation \& Constant folding):}  
    ...
    \item \textbf{Eliminación de código muerto (Dead code elimination):}  
    ...
    \item \textbf{Simplificación del flujo de control (Control flow graph simplification):}  
    ...
    \item \textbf{Optimización de bucles (Loop optimizations):}  
    ...
    \item \textbf{Inlining de funciones:}  
    ...
    \item \textbf{Optimización de expresiones comunes (Common subexpression elimination):}  
...
En el ejemplo anterior, podemos observar un ejemplo de \emph{constant folding}, donde la expresión original \emph{return 2+3*5;} puede ser traducida a \emph{return 2+15;} y finalmente \emph{return 17;}, obteniendo de esta manera un \emph{return statement} exento de cálculos.
