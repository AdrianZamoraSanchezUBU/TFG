...
T soporta los operadores aritméticos básicos: \texttt{+}, \texttt{-}, \texttt{*} y \texttt{/}.
...
Dentro de un evento puede utilizarse la instrucción \texttt{exit} para finalizar un evento concreto:
...
\begin{itemize}
    ...
    \item El bucle \texttt{for} restringe la inicialización y actualización a asignaciones.
