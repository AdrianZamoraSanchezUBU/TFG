...
\begin{itemize}
    ...
    \item \textbf{Tcompiler <archivo fuente> --visualizeAST:}  
    Genera una representación visual del Árbol de Sintaxis Abstracta (AST) en formato PDF.

    \item \textbf{Tcompiler <archivo fuente> -IR <archivo>:}  
    Exporta el código LLVM IR generado al archivo especificado.

    \item \textbf{Tcompiler <archivo fuente> -o <programa a generar>:}  
