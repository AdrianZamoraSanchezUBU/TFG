...
\textbf{Justificación de la elección:}  
El entorno Linux (conseguido mediente WSL) es especialmente sencillo para trabajar con las dependencias de este proyecto sin requerir capas de compatibilización adicionales requeridas por Windows (como MSYS2 o MinGW). 

Sus principales ventajas frente a Windows:
\begin{itemize}
    \item \textbf{Simpleza:} Con un entono únicamente de CLI permite un gran rendimiento y mantiene una sencillez coherente con el desarrollo de un compilador.
    ...
    \item \textbf{Integración:} Todos los paquetes están preparados para su uso en Unix-like, no se requiere ningún parche para compatibilizar las herramientas entre si. 
\end{itemize}
