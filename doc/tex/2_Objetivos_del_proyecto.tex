...
\begin{itemize}
    ...
    Desarrollar una pequeña biblioteca estándar, es decir, un conjunto de funciones básicas que proporcionen utilidades básicas dentro del lenguaje diseñado.
