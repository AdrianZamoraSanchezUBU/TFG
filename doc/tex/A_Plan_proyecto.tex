...
En este apartado se explica de que forma se aplicará la metodología ágil por excelencia, \emph{Scrum}, para el control temporal de este proyecto, cabe destacar que al ser un trabajo unipersonal con fin académico puede no reflejar a la perfección el trabajo habitual de esta metodología. 
...
A continuación se citan los \eng{sprints} realizados y una breve descripción de los mismos.
...
\textbf{\eng{Sprint} 10 (06/12/2025 - 12/12/2025):} Se completa una primera versión funcional del \eng{runtime}, se añaden operadores unarios \texttt{++} y \texttt{--}. Se añade una función print propia del lenguaje.
...
\textbf{\eng{Sprint} 12 (20/12/2025 - 26/12/2025):} Se completa el paso de parámetros mediante \texttt{libffi} entre \eng{runtime} y código compilado. Se añade la fase de optimización del compilador. 
...
\textbf{\eng{Sprint} 14 (04/01/2025 - 15/01/2025):} Realización de otros materiales como diapositivas de presentación, video de demostración y video defensa del proyecto.

Los datos de trazabilidad de los cambios exactos incluidos en cada \eng{milestone}, \eng{sprint} o \eng{issue} puede ser encontrado en GitHub o de igual manera en ZenHub.
...
\begin{itemize}
  \item \textbf{Coste humano:} Es el coste del salario que se requiere para el equipo que programara durante el proyecto. Puesto que es un proyecto con un único desarrollador, se estima un sueldo mensual de unos 1500€ brutos.
  \item \textbf{Coste hardware:} Este coste representa todo el material que requiere el equipo para funcionar correctamente, este comprende materiales como ordenadores, teclados, ratones, etc. Dando por hecho que en los 5 meses de proyecto solo se alquila el material necesario, se estima un alquiler mensual de 200€~\cite{alquilerpc} por hardware.
  \item \textbf{Coste software:} Estos son costos asociados comúnmente a desarrollos software, sin embargo, con la elección de software libre vamos a evitar este gasto tan común.
\end{itemize}
...
\tablaSmallSinColores{Licencias.}{lcr}{Licencias}{Herramienta/Biblioteca & Licencia \\}{
  Ubuntu & GPL \\
  ANTLR & BSD  \\
  LLVM & UIUC \\
  GCC & GPLv3 \\
...
Para este proyecto, se ha elegido una licencia \textbf{GPL}, para garantizar que el código se mantenga accesible, sin posibilidad de privatizarse. Esta decisión se hace siguiendo la filosofía~\cite{gcclicense} de grandes compiladores como \emph{GNU GCC} que han crecido y mejorado gracias al esfuerzo comunitario que permiten estas licencias.