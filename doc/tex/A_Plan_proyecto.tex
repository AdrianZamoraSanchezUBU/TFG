...
\textbf{Sprint 7 (15/11/2025 - 21/11/2025):} Se añade un runtime mínimo personalizado, se integran funciones de la librería estándar de C como printf, strlen e implementa una librería estándar propia con una función toString. Se añade el tipo que modelará el tiempo.
...
\textbf{Sprint 12 (20/12/2025 - 26/12/2025):}Se completa el paso de parámetros mediante libffi entre runtime y código compilado.
...
A continuación se citan todos las herramientas utilizadas y las licencias asociadas a las mismas:
