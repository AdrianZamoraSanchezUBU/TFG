...
\textbf{Sprint 7 (15/11/2025 - 21/11/2025):} Se añade un runtime mínimo personalizado, se integran funciones de la librería estándar de C como \code{printf}, \code{strlen} e implementa una librería estándar propia con una función toString. Se añade el tipo que modelará el tiempo.
...
\textbf{Sprint 9 (29/11/2025 - 05/12/2025):} Se realizan importantes mejoras de calidad del software. Se añade shadowing de variables y se comienza a hacer pruebas sobre 

\textbf{Sprint 10 (06/12/2025 - 12/12/2025):} Se completa una primera versión funcional del runtime, se añaden operadores unitarios \texttt{++} y \texttt{--}. Se añade una función print propia del lenguaje.

\textbf{Sprint 11 (13/12/2025 - 19/12/2025):} Se mejora la gestión de argumentos con la librería  y de errores del compilador mediante registro de información adicional y el uso de una estructura de datos específica para los errores.

\textbf{Sprint 12 (20/12/2025 - 26/12/2025):} Se completa el paso de parámetros mediante libffi entre runtime y código compilado. Se añade la fase de compilación. 

\textbf{Sprint 13 (27/12/2025 - 03/01/2025):} Refactorizaciones para aumentar la calidad del código. Redacción exhaustiva y revisiones de la memoria y anexos. 
...
A continuación se citan todos las herramientas y librerías utilizadas junto con las licencias asociadas a las mismas:
