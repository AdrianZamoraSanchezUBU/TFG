...
\begin{itemize}
    ...
    \item Preferencia por \texttt{std::unique\_ptr} y \texttt{std::shared\_ptr} para la gestión segura y automática de memoria.
\end{itemize}
...
\begin{verbatim}
  ...
  -IR             Generates a LLVM IR file. [nargs=0..1] [default: "ir"]
\end{verbatim}

Durante el desarrollo, se recomienda ejecutar el compilador en modo \texttt{-{}-debug} para facilitar el análisis del flujo interno de datos del sistema.
