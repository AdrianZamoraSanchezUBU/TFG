...
De forma resumida, el proyecto se organiza siguiendo una separación clara por responsabilidades, alineada con las distintas fases del compilador.
...
\begin{itemize}
    ...
    \item ANTLR4:
    \begin{itemize}
        \item Java Runtime Environment (JRE) para la herramienta ANTLR.
        \item Runtime de ANTLR4 para C++ instalado en el sistema.
    \end{itemize}
...
\begin{itemize}
    ...
    \item Preferencia por \texttt{std::unique\_ptr} y \texttt{std::shared\_ptr} para la gestión de memoria.
\end{itemize}
...
\begin{itemize}
  ...
  Contiene el sistema de ejecución en tiempo de ejecución (runtime), incluyendo la gestión de eventos, temporización y funciones auxiliares.
...
El proyecto no requiere un proceso de instalación formal. Una vez compilado, el ejecutable puede copiarse a cualquier directorio del sistema.
...
El compilador se ejecuta desde línea de comandos indicando como argumento el archivo fuente a compilar. Opcionalmente, se pueden añadir distintas banderas para depuración, visualización del AST o generación de LLVM IR.
