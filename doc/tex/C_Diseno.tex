...
\begin{itemize}
    ...
    \item El almacenamiento estructurado y organización de los datos.
    \item La detección temprana de errores.
    \item Separación de responsabilidades de representación y transformación.
...
\begin{itemize}
    \item Tipos primitivos: enteros, booleanos, caracteres y valores numéricos en coma flotante.
    ...
    \item Tipos referencia, que permiten el paso por referencia y la manipulación indirecta de valores.
\end{itemize}
...
\begin{itemize}
    ...
    \item Constructor del AST
    \item Analizador semántico.
    \item Generador de código intermedio.
    \item Optimizador de código intermedio.
    \item Generador de código ejecutable.
\end{itemize}
...
El sistema de eventos se gestiona en tiempo de ejecución mediante un mecanismo de planificación basado en hilos. Cada evento se registra función la cual será ejecutada según unos parámetros de ejecución, tales como el periodo de ejecución, el limite de ejecuciones y los parámetros de entrada.

El \textit{runtime} se encarga de:
\begin{itemize}
    \item Iniciar la ejecución del programa.
    \item Registrar los eventos definidos en el programa.
    \item Registrar y gestionar los parámetros que se le pasan al evento (en caso de que los haya).
    \item Lanzar los eventos, permitiendo su autogestión. 
    \item Gestionar el ciclo de vida de los eventos, así como su correcta terminación.
\end{itemize}
