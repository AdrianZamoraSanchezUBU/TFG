...
Este proceso permite reconocer de forma eficiente los tokens del lenguaje, que serán consumidos por el analizador sintáctico.

\subsection{Algoritmo del analizador sintáctico}
El analizador sintáctico utiliza el algoritmo \textit{Adaptive LL(*)} proporcionado por ANTLR. Este enfoque combina dos modos de análisis:
\begin{itemize}
